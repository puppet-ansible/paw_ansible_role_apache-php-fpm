# paw_ansible_role_apache_php_fpm
# @summary Manage paw_ansible_role_apache_php_fpm configuration
#
...
class paw_ansible_role_apache_php_fpm (
...
# Check for common paw::par_vardir setting, then module-specific, then default
  ...
  $playbook_path = "${_par_vardir}/lib/puppet_x/ansible_modules/ansible_role_apache_php_fpm/playbook.yml"

  par { 'paw_ansible_role_apache_php_fpm-main':
    ensure        => present,
